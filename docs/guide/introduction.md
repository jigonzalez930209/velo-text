...
Current trial: **`1.0.0`** — `pnpm add velo-text@beta`. The API is not frozen. Install and token steps: [Publish to npm](/guide/publish). What is done vs next: [Roadmap](/guide/roadmap).
