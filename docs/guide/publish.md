...
Current version: **`1.0.0-beta.4`** (npm dist-tag `beta`).
...
```bash
pnpm version:set 1.0.0-beta.4
# edit CHANGELOG.md if needed
git add -A && git commit -m "release: 1.0.0-beta.4"
...
- Next beta: bump to `1.0.0-beta.4`, commit, tag `v1.0.0-beta.4`, push the tag.
