...
function makeSampleDoc() {
  ...
  const pngAsset = { id: "vis_img", kind: "image", mediaType: "image/png", storageKey: "k", sha256: "a".repeat(64), byteLength: 100, alt: "test image" };
...
for (const theme of Object.keys(themes)) {
  ...
  const icons = ["bold", "italic", "underline", "variable", "equation", "table", "image", "plus", "trash"];
